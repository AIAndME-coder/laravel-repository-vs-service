...
<div class="header">
    <div>
        <h1>Product Details <span class="badge" style="background: #f59e0b;">Service Layer</span></h1>
    </div>
    <div class="actions">
        <a href="{{ route('service.products.edit', $product) }}" class="btn btn-primary">Edit</a>
...
<div style="background: #f9fafb; padding: 30px; border-radius: 8px; margin-top: 20px;">
    ...
    <div style="margin-bottom: 20px;">
        ...
        <div style="font-size: 24px; color: #f59e0b; font-weight: 700;">${{ number_format($product->price, 2) }}</div>
    </div>
