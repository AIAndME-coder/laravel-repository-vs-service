...
@section('title', 'View Product - Service Layer Approach')

@section('content')
<div class="tw:flex tw:justify-between tw:items-center tw:mb-6 tw:pb-5 tw:border-b tw:border-gray-200">
    <div>
        <h1 class="tw:text-3xl tw:font-bold tw:text-gray-900">Product Details <span class="tw:inline-flex tw:items-center tw:px-3 tw:py-1 tw:rounded-full tw:text-xs tw:font-semibold tw:bg-amber-100 tw:text-amber-800">Service Layer</span></h1>
        <p class="tw:mt-2 tw:text-sm tw:text-gray-600">View complete product information</p>
    </div>
    <div class="tw:flex tw:gap-3">
        <a href="{{ route('service.products.edit', $product) }}" class="tw:inline-flex tw:items-center tw:px-4 tw:py-2 tw:bg-blue-600 tw:text-white tw:font-semibold tw:rounded-lg hover:tw:bg-blue-700 tw:transition-colors tw:shadow-sm">
...
<div class="tw:bg-white tw:shadow-lg tw:rounded-lg tw:overflow-hidden">
    <div class="tw:bg-gradient-to-r tw:from-amber-500 tw:to-orange-600 tw:px-6 tw:py-4">
    ...
    <div class="tw:p-6 sm:tw:p-8 tw:space-y-6">
        <div class="tw:grid tw:grid-cols-1 md:tw:grid-cols-2 tw:gap-6">
            ...
            <div class="tw:bg-gradient-to-br tw:from-amber-50 tw:to-orange-50 tw:p-4 tw:rounded-lg tw:border-2 tw:border-amber-200">
                <label class="tw:block tw:text-xs tw:font-semibold tw:text-amber-700 tw:uppercase tw:tracking-wide tw:mb-2">Price</label>
                <div class="tw:text-3xl tw:font-bold tw:text-amber-600">${{ number_format($product->price, 2) }}</div>
            </div>
        </div>
